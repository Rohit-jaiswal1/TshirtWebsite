...
//const designRoutes = require('./routes/shop/designRoutes');  // <-- Import the design routes
const tshirtRoutes=require('./routes/shop/customize-routes')
const app = express();
dotenv.config();
...
app.use("/api/tshirts/save", tshirtRoutes);
// Use the design routes here
